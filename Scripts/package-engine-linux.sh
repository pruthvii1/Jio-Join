...
cp "$task_root/linux/jiojoin_controller.py" "$task_stage/jiojoin_controller.py"
cp "$task_root/linux/jiojoin_desktop.py" "$task_stage/jiojoin-desktop"
cp "$task_root/linux/install.sh" "$task_stage/install.sh"
cp "$task_root/linux/uninstall.sh" "$task_stage/uninstall.sh"
cp "$task_root/linux/io.github.pruthvii1.JioJoin.desktop" "$task_stage/io.github.pruthvii1.JioJoin.desktop"
...
chmod 755 "$task_stage/jiojoin-controller" "$task_stage/jiojoin_controller.py" "$task_stage/jiojoin-desktop" "$task_stage/install.sh" "$task_stage/uninstall.sh"
